 ...
 *
 */
public class USonarMessageTestCase {

	/**
	 * Test method for {@link AP2DX.usarsim.specialized.USonarSensorMessage#parseMessage()}.
	 */
	@Test
	public void testParseMessage() {
		try {
			USonarSensorMessage msg = new USonarSensorMessage("SEN {Time 395.6055} {Type Sonar} {Name F1 Range 4.5604} {Name F2 Range 2.4576} {Name F3 Range 1.8846} {Name F4 Range 1.6543} {Name F5 Range 0.6501} {Name F6 Range 0.7861} {Name F7 Range 1.1415} {Name F8 Range 2.0603}");
			msg.parseMessage();
